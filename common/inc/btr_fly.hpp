...
*/
extern "C" void comp_pair(long double*, long double*, long double*, long double*);

extern "C" void comp_seqn(int, long double*, int, long double*, int, long double*, int, long double*, int);
